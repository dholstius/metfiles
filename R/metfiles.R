#' Reads meteorology data from formats commonly used in dispersion modeling.
#'
#' \tabular{ll}{
#' Package: \tab metfiles\cr
#' Type: \tab Package\cr
#' Version: \tab 0.1\cr
...
#' @aliases metfiles
#' @docType package
#' @title Reads meteorology data from formats commonly used in dispersion modeling
